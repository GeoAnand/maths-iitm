		...
		<div class="col-sm-12" style="margin:10px">
            ...
            <div id="albumlist">
                ...
                @for($i=0;$i<=count($getalbums)-1;$i++)
                    <div class="col-sm-4 linked-card" data-href="{{url('resources/album/'.$getalbums[$i]['id'])}}">
                        <section class="panel dpt-bg-light">
                            <div class="panel-body lter">
                              <div class="text-center padder m-t">                              
                                <a href="{{url('resources/album/'.$getalbums[$i]['id'])}}">                          
                                    <span class="h4 block">
            ...
            @else
                <span class="text-muted wrapper text-center center-block">
                    <i class="fa fa-warning fa-4x"></i> <br/>Sorry! There are no albums to be displayed.
                </span>
            @endif
        </div>
	</div>
