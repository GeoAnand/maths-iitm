...
@if (($getprogdetails->id!=5)) <!-- EDITED BY NARAYANAN to branch out the B.Tech (progam id=5) from other -->
			<div class="col-sm-4">
...
<!--					<div class="col-sm-12 m-t" style="">
					...
					<header class="">
					    <ul class="nav nav-tabs" id="programmenutab">
							...
							@endfor
@if(($getprogdetails->id==3)) 
<li class="sem"><a href="#tab{{$i}}" data-toggle="tab">Courses</a></li> <!--# EDITED by NARAYANAN to add elective tab.-->
@else
