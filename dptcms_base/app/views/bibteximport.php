...
/** MySQL database username  originally math*/
@define('DB_USER', 'math');
...
@define('BIBTEX_TABLE', 'publications');
...
$path = "/wxt/websites/math/test/data/publications/bibtex/publications.bib";

try {
  $bibtex_db = init_bibtexbrowser($path);
