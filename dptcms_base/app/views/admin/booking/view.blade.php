...
<div class="col-sm-12">
    <ul class="breadcrumb">
      ...
      <li class="active">Pending Booking Requests</li>
    </ul>
    <section class="panel">    
      ...
      <div class="panel-body">
        <div class="col-sm-12">
          <h5 style="display:inline" class="pull-right">Total : ({{count($getpendingbooking)}})</h5>
          @if(count($getpendingbooking))
                      <table class="table table-striped m-b-none text-sm">
                        ...
                        <?php $i=1; ?>                        
                            @foreach($getpendingbooking as $val)
                              <tr>                    
                                  <td>
                                  {{$i}} 
                                  </td>
