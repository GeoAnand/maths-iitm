...
@section('header-title')
   <title>Admin Panel - Inspire faculty | DeptCMS</title>
@stop
   ...
   <div class="col-sm-12">
     <!-- .breadcrumb -->
      <ul class="breadcrumb">
        ...
        <li class="active"> Inspire Faculty</li>
      </ul>
     <!-- / .breadcrumb -->
    <section class="panel">
       <header class="panel-heading text-right bg-light">
         <ul class="nav nav-tabs pull-left">
           <li class="active"><a href="#faculties" data-toggle="tab"><i class="fa fa-user text-default"></i> Inspire Faculty Members</a></li>
          <!--  <li class="">
         ...
         <div class="tab-content">              
           <div class="tab-pane fade active in" id="faculties">
               <header class="panel-heading">
                 Inspire Faculty Members
                 <i class="fa fa-info-sign text-muted" data-toggle="tooltip" data-placement="bottom" data-title="ajax to load the data."></i> 
               </header>
               <div class="table-responsive">
                 <table class="table table-striped m-b-none" id="inspireTable">
                   <thead>
                     <tr>
                        <th width="20%">Name</th>
    ...
    var oTable;
      $(document).ready(function() {
            $('#inspireTable').dataTable( {
                "processing": true,
                "serverSide": true,
                "sAjaxSource": "{{ URL::to('admin/allinspirefaculty')}}",
            });
      });
    </script>
