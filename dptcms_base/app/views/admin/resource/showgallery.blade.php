  ...
  <section class="panel">    
    ...
    <div class="panel-body">
        <div class="col-sm-12" style="margin:10px">
            ...
            <div id="albumlist">
                <h4>Album List</h4>
                @for($i=0;$i<=count($getalbums)-1;$i++)
                    <div class="col-sm-4 linked-card" data-href="{{url('admin/resources/managealbum/'.$getalbums[$i]['id'])}}">
                        <section class="panel bg-light">
                            <div class="panel-body lter">
                              <div class="text-center padder m-t">                              
                                <a href="{{url('admin/resources/managealbum/'.$getalbums[$i]['id'])}}">                          
                                    <span class="h4 block">
                                        <i class="fa fa-picture-o"></i> {{$getalbums[$i]['resource_album_name']}}
                                    </span>
                                </a>
                              </div>
                            </div>
...
<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form role="form" id="createAlbumform" method="post" action="{{url('resources/album/0')}}" enctype="multipart/form-data">
