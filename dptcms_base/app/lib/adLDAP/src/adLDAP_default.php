...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@iitm.ac.in";
    ...
    * @var string
    */
	protected $baseDn = "dc=iitm,dc=ac,dc=in"; 
    ...
    * @var array
    */
    protected $domainControllers = array("10.24.3.51");
    #protected $domainControllers = array("10.91.11.1");
    ...
    * @var string
    */
	protected $adminUsername = "phoffice";
    protected $adminPassword = "Password4850";
